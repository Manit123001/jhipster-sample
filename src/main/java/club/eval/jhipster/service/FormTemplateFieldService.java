...
public class FormTemplateFieldService {
    ...
    private final Logger log = LoggerFactory.getLogger(FormTemplateFieldService.class);
    ...
    public FormTemplateFieldService(FormTemplateFieldRepository formTemplateFieldRepository, FormTemplateFieldSearchRepository formTemplateFieldSearchRepository) {
