...
@Service
@Transactional
public class FormTemplateFieldArrayServiceImpl implements FormTemplateFieldArrayService{

    private final Logger log = LoggerFactory.getLogger(FormTemplateFieldArrayServiceImpl.class);
    ...
    public FormTemplateFieldArrayServiceImpl(FormTemplateFieldArrayRepository formTemplateFieldArrayRepository, FormTemplateFieldArraySearchRepository formTemplateFieldArraySearchRepository) {
