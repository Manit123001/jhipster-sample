...
class HealthRecordAttrGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the HealthRecordAttr entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "templateId":null, "templateFieldId":null, "fieldName":"SAMPLE_TEXT", "fieldValue":"SAMPLE_TEXT", "isExistRecord":null, "recordTable":"SAMPLE_TEXT", "recordField":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
